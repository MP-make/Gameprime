// filepath: c:\Users\ASUS\Desktop\Gameprime\GamePrime-main\vistas\pagoFallo.php
<?php
$orden_id = $_GET['orden_id'] ?? 'N/A';
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Pago Fallido - GamePrime</title>
...
<body>
    ...
    <main class="pago-resultado">
        <div class="resultado-container">
            <h1>Pago Fallido</h1>
            <p>Lo sentimos, tu pago no pudo ser procesado. Por favor, intenta nuevamente.</p>
            <p>Número de Orden: <?php echo htmlspecialchars($orden_id); ?></p>
            <a href="index.php?accion=verCarrito" class="btn-volver">Volver al Carrito</a>
        </div>
    </main>
